...
func handle_rotation(delta: float) -> void:
    ...
    var speed_factor = clamp(actual_movement_speed.length()/50, 0, 1);
    ...
    var pitch_adjustment = (speed_pitch_adjustment + attitude_pitch_adjustment + roll_pitch_adjustment) * speed_factor * 0.5;
